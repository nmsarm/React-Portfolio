            ...
            >
                <div className="container">
                    ...
                    <Navbar.Collapse id="responsive-navbar-nav navbar-nav">
                        <Nav className={navbar ? "navbar-nav ms-auto" : "me-auto offset-lg-3" && isMobile? "navbar-nav ms-auto" : "me-auto offset-3"}>
                            <Nav.Link href="#home" className={navbar ? "nav-link" : "nav-link offset-md-1" && isMobile? "nav-link" : "nav-link offset-md-1"}>
                                <p
                            ...
                            <Nav.Link href="#about" className={navbar ? "nav-link" : "nav-link offset-md-2" && isMobile? "nav-link" : "nav-link offset-md-2"}>
                                <p
                                    className={navbar ? "pt-3 hover-underline-animation2" : "text-white pt-3 hover-underline-animation"}
                                >
                                    About
                            ...
                            <Nav.Link href="#works" className={navbar ? "nav-link" : "nav-link offset-md-2" && isMobile? "nav-link" : "nav-link offset-md-2"}>
                                <p
                                    className={navbar ? "pt-3 hover-underline-animation2" : "text-white pt-3 hover-underline-animation"}
                                >
                                    Projects
